...
class VersionGate1 {
  /// Returns a new [VersionGate1] instance.
  VersionGate1({
  ...
  factory VersionGate1.fromJson(Map<String, dynamic> json) => _$VersionGate1FromJson(json);

  Map<String, dynamic> toJson() => _$VersionGate1ToJson(this);
