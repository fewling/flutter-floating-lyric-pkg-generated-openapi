...
class VersionGate3 {
  /// Returns a new [VersionGate3] instance.
  VersionGate3({
  ...
  factory VersionGate3.fromJson(Map<String, dynamic> json) => _$VersionGate3FromJson(json);

  Map<String, dynamic> toJson() => _$VersionGate3ToJson(this);
