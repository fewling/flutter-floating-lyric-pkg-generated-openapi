...
class VersionGate {
  /// Returns a new [VersionGate] instance.
  VersionGate({
  ...
  factory VersionGate.fromJson(Map<String, dynamic> json) => _$VersionGateFromJson(json);

  Map<String, dynamic> toJson() => _$VersionGateToJson(this);
